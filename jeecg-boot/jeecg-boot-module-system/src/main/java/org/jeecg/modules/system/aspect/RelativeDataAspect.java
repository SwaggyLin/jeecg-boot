...
public class RelativeDataAspect {
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        System.out.println("dcit start:"+JSONUtil.toJsonStr(result));
        ...
        System.out.println("dict end:"+JSONUtil.toJsonStr(result));
        return result;
    }
    ...
    private void parseDictText(Object result) {
        if (result instanceof Result) {
            if (((Result) result).getResult() instanceof IPage) {
                Class<?> clazz=((IPage) ((Result) result).getResult()).getRecords().getClass();
                ...
                for (Object record : ((IPage) ((Result) result).getResult()).getRecords()) {
                    ...
                    //update-end--Author:scott  -- Date:20190603 ----for：解决继承实体字段无法翻译问题------
                        System.out.println(field.getName()+field.getAnnotation(Dict.class));
