  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/edu/eduTeacher/list",
          delete: "/edu/eduTeacher/delete",
          deleteBatch: "/edu/eduTeacher/deleteBatch",
          exportXlsUrl: "/edu/eduTeacher/exportXls",
          importExcelUrl: "edu/eduTeacher/importExcel",
        },
        dictOptions:{
         sex:[],
        },
