        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="年级">
              <j-dict-select-tag placeholder="请选择年级" v-model="queryParam.classGrade" dictCode="classGrade"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8" >
          ...
          },
          {
            ...
            customRender:(text)=>{
              if(!text){
                ...
                return filterMultiDictText(this.dictOptions['classTeacherId'], text+"")
              }
            }
          },
          {
            ...
            customRender:(text)=>{
              if(!text){
                ...
                return filterMultiDictText(this.dictOptions['classGrade'], text+"")
              }
            }
          },
          {
    ...
    methods: {
      initDictConfig(){
        initDictOptions('').then((res) => {
          if (res.success) {
            this.$set(this.dictOptions, 'classTeacherId', res.result)
          }
        })
        initDictOptions('classGrade').then((res) => {
          if (res.success) {
            this.$set(this.dictOptions, 'classGrade', res.result)
          }
        })
      }
