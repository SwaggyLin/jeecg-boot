  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/edu/eduStudent/list",
          delete: "/edu/eduStudent/delete",
          deleteBatch: "/edu/eduStudent/deleteBatch",
          exportXlsUrl: "/edu/eduStudent/exportXls",
          importExcelUrl: "edu/eduStudent/importExcel",
        },
        dictOptions:{
         sex:[],
         classId:[],
